...
<html lang="en">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container"> 
				...
				<a class="brand" href=""><b><font color="white">Import Excel To MySQL Database Using PHP</font></b></a>				
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<?php 
		$sql_numrow = "SELECT COUNT(*) NUMROWS FROM HISTORY_TRAINING";
		...
		echo "<center><h3>ข้อมูลจากฐานข้อมูล ".$usedatabase." รวม ".$NUMROWS." ชุด</h3></center>" ; 
	?>
		...
		<table id="myTable" class="table table-bordered">
			...
			<?php
				$SQLSELECT = "SELECT * FROM HISTORY_TRAINING ";
